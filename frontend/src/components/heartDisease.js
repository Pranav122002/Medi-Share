        ...
        <div className="heartdis">
              ...
              {reports.map((report, index) => (
                <div key={index}>
                  ...
                  >
                    ...
                    <p>
                      Resting Electrocardiographic Results: {report.restecg}
                    </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            /> */}
              ...
              <div className="flexxx">
                <div className="heartflexbox">
                  <label>
                    ST depression induced by exercise relative to rest (Range 0
                    - 6.2):
                  </label>
                  <input
                    type="number"
          ...
          {prediction !== null && (
            <p id="hesatdiuscno">
              ...
              {prediction === 1
                ? "Heart Disease detected"
                : "Heart Disease not found"}
            </p>
          )}
          {prediction !== null && (
            <button id="kidimgp" onClick={handleSave}>
              Save report
            </button>
          )}
        </div>
