    ...
    <>
      ...
      <div className="chatfunc">
        <div className="chatcont">
          ...
          <p>Take active part in community meetings and gatherings. Interact with other people in personal and community chats.
            Get latest news about community services.
          </p>
        </div>
      ...
      <div className="linkcont">
        <Link to="/personal-chat">
          ...
          <li className="Cnavli">
            ...
            <button className="button-53" value="Donate" role="button">Click to start chatting</button>
          </li>
        </Link>
