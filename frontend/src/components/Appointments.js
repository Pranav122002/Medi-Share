...
export default function Appointments() {
  ...
  function fetchMyDoctorAppointments() {
    ...
    fetch(`/my-doctor-appointments/${doctorId}`, {
      headers: {
  ...
  function fetchMyPatientAppointments() {
    ...
    fetch(`/my-patient-appointments/${patientId}`, {
      headers: {
        Authorization: "Bearer " + localStorage.getItem("jwt"),
      },
    })
  ...
  function rejectAppointment(appointmentId) {
    fetch(`/reject-appointment/${appointmentId}`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
  ...
  function addLink(appointmentId) {
    fetch(`/add-appointment-link/${appointmentId}`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
  ...
  function addRatingFeedback(selectedAppointment) {
    ...
    fetch(`/add-rating-feedback/${selectedAppointment}`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("jwt"),
