...
router.put("/update-volunteer-details/:id", (req, res) => {
...
router.put("/update-doctor-details/:id", (req, res) => {
...
router.get("/all-volunteers-and-doctors", (req, res) => {
...
router.post("/user-cart/:id", (req, res) => {
  const cart = req.body;
...
router.get("/all-verified-doctors", (req, res) => {
...
router.put("/end-subscription/:id", (req, res) => {
  USER.findByIdAndUpdate(
    req.params.id,
